    ...
    let products = [
        {
            name: 'Урт Түрүүтэй',
            price: 470000,
            imgSrc1: '/images/ratio/product1.jpg',
            imgSrc2: '/images/ratio/5.jpg',
            hasBoots: 'long',
            color: 'Бор',
            sex: 'man'
        },
            ...
            ` <li class="grid-item wow animate__fadeIn" data-wow-delay="0.2s">
                    <div class="product-box margin-25px-bottom xs-margin-15px-bottom">
                        ...
                        <div class="product-footer text-center padding-25px-top xs-padding-10px-top">
                            <a href="single.html" class="text-extra-dark-gray font-weight-500 d-inline-block">${product.name} ${product.color}</a>
